...
|---|---|---|
| `SWARM_ORG_NAME` | `"Swarm"` | Sidebar header (next to logo) |
...
| `SWARM_CLOUD` | `false` | When `true`, marks the deployment as cloud-hosted. Gates the user-menu Docs/Support/Billing items (Phase 2) and suppresses the self-host marketing link. |
