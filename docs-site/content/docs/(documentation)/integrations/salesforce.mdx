...
<Callout type="info">
The OAuth setup (Connected App, redirect URI, global secrets) is the same regardless of which Salesforce MCP endpoint you use. Register whichever endpoint fits your use case and choose the OAuth scopes accordingly.
</Callout>
