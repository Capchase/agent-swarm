...
- [**Salesforce**](/docs/integrations/salesforce) — read-only sObject MCP connector authenticated via OAuth. Lets agents run SOQL reads against your Salesforce org.
